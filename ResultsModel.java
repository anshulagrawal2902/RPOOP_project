package com.example.android.rpoop_api_fetcher.models;
...
public class ResultsModel implements Parcelable {
    ...
    public ResultsModel(Parcel in) {
        in.readList(this.questions, com.example.android.rpoop_api_fetcher.models.QuestionModel.class.getClassLoader());
    }
